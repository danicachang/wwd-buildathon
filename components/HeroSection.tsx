        ...
        <section className='darkBlue'>
            <div className='hero content flex flex-space-between flex-mobile-col responsive-2-columns'>
                <div>
                    ...
                    <h2>We aim to bring 100 participants to build travel products and services for our community.</h2>
                    <a href='' target="_blank" rel="noreferrer"><button className='pink margin-top fullWidth-mobile'>Sign Up</button></a>
                </div>
