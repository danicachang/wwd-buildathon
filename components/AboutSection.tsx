      ...
      <div className="content">
        ...
        <div className="flex flex-mobile-col">
          ...
          <div className="padding-h larger">
            ...
            <p>
              As a community, we want to focus on building products and services
              to help women globally achieve financial, location, and creative
              independence, we're hoping to{' '}
              <strong>kickstart the entrepreneurial community spirit</strong> we
              aim to build within our community.
            </p>
            ...
            <p>
              The Buildathon is a three day online event happening from{' '}
              <strong>19 - 21 August </strong>happening on Discord and Zoom.
            </p>
