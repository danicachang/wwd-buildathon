      ...
      <div className="content flex flex-wrap flex-v-center">
        <a className="mobile" href="/">
          <img
            ...
            style={{ width: '75px', marginTop: '2rem' }}
          />
          <h3 className="semibold smallMargin">Wander Women</h3>
          <h4 className="notBold noMargin" style={{ fontSize: '1.25rem' }}>
            Buildathon
          </h4>
        </a>
        <a className="tablet-desktop" href="/">
          <h3 className="notBold">Wander Women • Buildathon</h3>
        </a>
